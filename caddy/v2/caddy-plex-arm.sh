...
echo "${latest_version}"
caddy_link="https://github.com/lxhao61/integrated-examples/releases/download/${latest_version}/caddy_linux_arm64.tar.gz"
...
:443, $host, $plex { #xx.yy修改为自己的域名。注意：逗号与域名之间有一个空格。
	tls {
